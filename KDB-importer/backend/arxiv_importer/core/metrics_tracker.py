...
class MetricsTracker:
    ...
    def _create_tables(self, cursor):
        ...
        # Create indexes
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_activity_events_date ON activity_events(date)")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_activity_events_type ON activity_events(event_type)")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_keyword_extractions_date ON keyword_extractions(date)")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_paperless_uploads_date ON paperless_uploads(date)")
